<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="FreelancersBook.admin" %>
                            ...
                            <table align="center" class="auto-style18">
                                ...
                                <tr>
                                    <td class="auto-style19">
                                        ...
                                        <strong>
                                        <br />
                                        <asp:Label ID="Label25" runat="server" CssClass="auto-style21" Text="Freelancers:"></asp:Label>
                                        </strong></td>
                                    <td class="auto-style29">
                                        <br />
                                        <asp:TextBox ID="flcount" runat="server" CssClass="auto-style23" Height="25px" Width="330px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style19">
                                        ...
                                        <strong>
                                        <br />
                                        <asp:Label ID="Label27" runat="server" CssClass="auto-style21" Text="Referrals:"></asp:Label>
                                        </strong></td>
                                    <td class="auto-style29">
                                        <br />
                                        <asp:TextBox ID="referbox" runat="server" CssClass="auto-style23" Height="350px" Width="635px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <td>
                            ...
                            <table align="center" class="auto-style18">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br />
                                        <asp:TextBox ID="myAid" runat="server" CssClass="auto-style23" Height="25px" Width="330px" OnTextChanged="myAid_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style19">
                                ...
                                <tr>
                                    <td class="auto-style19">
                                        <br />
                                        <strong>
                                        <asp:Label ID="Label28" runat="server" CssClass="auto-style21" Text="Balance"></asp:Label>
                                        </strong></td>
                                    <td>
                                        <asp:TextBox ID="myBalance" runat="server" CssClass="auto-style23" Height="25px" Width="330px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style19">&nbsp;</td>
...
&nbsp;
                            ...
                            &nbsp;
                            <asp:Button ID="Button58" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="withdraw_funds_click" Text="Withdraw Funds" Width="213px" />
&nbsp;
                            <asp:Button ID="Button45" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="apply_first_job" Text="Invite First Job" Width="213px" />
                            &nbsp;
                            <asp:Button ID="Button48" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="Resend_Welcome" Text="Resent Welcome" Width="213px" />
                            <br />
                            <br />
                            ...
                            <br />
                            &nbsp;
                            <asp:Button ID="Button54" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="Switch_User" Text="Refund Msg" Width="213px" />
                            &nbsp;
                            ...
                            &nbsp;
                            <asp:Button ID="Button56" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="Switch_User" Text="Switch Freelancer" Width="224px" />
                            &nbsp;
                            <asp:Button ID="Button59" runat="server" BorderColor="Gray" BorderWidth="4px" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#6600CC" Height="67px" OnClick="Switch_User" Text="Payment Done" Width="213px" />
                            <br />
                            <br />
                            <asp:TextBox ID="referbox2" runat="server" CssClass="auto-style23" Height="350px" TextMode="MultiLine" Width="635px"></asp:TextBox>
                            <br />
                            <br />
                            &nbsp;&nbsp;
