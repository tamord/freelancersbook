<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="FreelancersBook.signup" %>
...
.myButton:active {
                ...
                <table align="center" class="auto-style7">
                    <tr>
                        <td colspan="2">
                            <br />
                            <br />
                            <asp:Image ID="Image1" runat="server" Height="264px" ImageUrl="~/images/hirelogo.jpg" Width="722px" />
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style8">
                            <br />
                            <asp:Label ID="Label191" runat="server" CssClass="auto-style9" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large" style="color: #336699" Text="Already Signed Up?"></asp:Label>
                            <br />
                            &nbsp;<br />
                            <br />
                            <table align="center" class="auto-style36">
                                <tr>
                                    <td class="auto-style37"><span>
                                        <asp:ImageButton ID="ImageButton4" runat="server" Height="64px" ImageUrl="~/images/reglogin2.png" OnClick="login" />
                                        </span></td>
                                    <td class="auto-style38"><span>&nbsp;&nbsp;
                                        <asp:ImageButton ID="ImageButton5" runat="server" Height="64px" ImageUrl="~/images/fbconnect3.png" OnClick="fblogin_click" />
                                        </span></td>
                                </tr>
                            </table>
                            <br />
                        ...
                        <td class="auto-style21">
                            <asp:Image ID="Image29" runat="server" ImageUrl="~/images/login-gray2.JPG" />
                        </td>
                    </tr>
                </table>
            </asp:View>
    ...
    <p>
        &nbsp;</p>
                <table align="center" class="auto-style10" __designer:mapid="8c5">
                    <tr __designer:mapid="8c6">
                        <td __designer:mapid="8c7">
                            <br __designer:mapid="8c8" />
                            <br __designer:mapid="8c9" />
                            <asp:Image ID="Image30" runat="server" ImageUrl="~/images/hirelogo2.png" />
                            <br __designer:mapid="a8b" />
                            ...
                            <br __designer:mapid="8cb" />
                            <br __designer:mapid="8cc" />
                            <br __designer:mapid="8cd" />
                            <table class="auto-style11" __designer:mapid="8ce">
                                <tr __designer:mapid="8cf">
                                    <td __designer:mapid="8d0" class="auto-style23">
                                        <img src="https://www.ads-rush.com/email2.jpg" width="30" __designer:mapid="8d1" />
                                    ...
                                    <td __designer:mapid="8d7" class="auto-style26">
                                ...
                                <tr __designer:mapid="8e7">
                                    <td __designer:mapid="8e8" class="auto-style23">
                                        <br __designer:mapid="8e9" />
                                        <img src="https://www.ads-rush.com/password2.jpg" width="30" __designer:mapid="8ea" />
                                        &nbsp;&nbsp;
                                    ...
                                    <td __designer:mapid="8f1" class="auto-style26">
                                ...
                                <tr __designer:mapid="8fe">
                                    <td __designer:mapid="8ff" class="auto-style23">
                                        <br __designer:mapid="900" />
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="Label165" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large" style="color: #336699" Text="Your Full Name:"></asp:Label>
                                    </td>
                                    <td __designer:mapid="902" class="auto-style24">
                                        <br __designer:mapid="903" />
                                        <asp:TextBox ID="myfullname" runat="server" CssClass="auto-style15" Height="30px" Width="280px"></asp:TextBox>
                                    </td>
                                    <td __designer:mapid="905" class="auto-style27">
                                    ...
                                    <td __designer:mapid="907" class="auto-style26">
                                ...
                                <tr __designer:mapid="922">
                                    <td __designer:mapid="923" class="auto-style23">
                                        <br __designer:mapid="924" />
                                    ...
                                    <td __designer:mapid="927" class="auto-style24">
                                        <br __designer:mapid="928" />
                                    ...
                                    <td __designer:mapid="a18" class="auto-style27">
                                        <br />
                                    ...
                                    <td __designer:mapid="a1a" class="auto-style26">
                                        <br />
                                ...
                                <tr __designer:mapid="a2c">
                                    <td class="auto-style22" __designer:mapid="a2d">
                                        <br __designer:mapid="a2e" />
                                    ...
                                    <td class="auto-style25" __designer:mapid="a31">
                                        <br __designer:mapid="a32" />
                                        <asp:TextBox ID="myskype" runat="server" CssClass="auto-style15" Height="30px" Width="280px"></asp:TextBox>
                                    </td>
                                    <td class="auto-style28" __designer:mapid="a34">
                                        <br __designer:mapid="a35" />
                                    </td>
                                    <td class="auto-style13" __designer:mapid="a36">&nbsp;</td>
                                </tr>
                                <tr __designer:mapid="a37">
                                    <td class="auto-style22" __designer:mapid="a38">
                                        <br __designer:mapid="a39" />
                                    ...
                                    <td class="auto-style25" __designer:mapid="a3c">
                                        <br __designer:mapid="a3d" />
                                        <asp:TextBox ID="mywhatsapp" runat="server" CssClass="auto-style15" Height="30px" Width="280px"></asp:TextBox>
                                    </td>
                                    <td class="auto-style28" __designer:mapid="a3f">
                                        <br __designer:mapid="a40" />
                                    </td>
                                    <td class="auto-style13" __designer:mapid="a41">&nbsp;</td>
                                </tr>
                                <tr __designer:mapid="a7e">
                                    <td class="auto-style22" __designer:mapid="a7f">
                                        <br __designer:mapid="a80" />
                                        <asp:Image ID="Image28" runat="server" ImageUrl="~/images/linkedinlightgray.jpg" Width="30px" />
                                        &nbsp;<asp:Label ID="Label182" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large" style="color: #336699" Text="Linkedin:"></asp:Label>
                                    </td>
                                    <td class="auto-style25" __designer:mapid="a83">
                                        <br __designer:mapid="a84" />
                                        <asp:TextBox ID="mylinkedin" runat="server" CssClass="auto-style15" Height="30px" Width="280px"></asp:TextBox>
                                    </td>
                                    <td class="auto-style28" __designer:mapid="a86">
                                        <br __designer:mapid="a87" />
                                    </td>
                                    <td class="auto-style13" __designer:mapid="a88">&nbsp;</td>
                                </tr>
                                </table>
                            <span __designer:mapid="a52">
                            <br __designer:mapid="a53" />
                            <br />
                            <asp:ImageButton ID="ImageButton6" runat="server" Height="64px" ImageUrl="~/images/signup.png" OnClick="signup2" />
                            &nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton7" runat="server" Height="64px" ImageUrl="~/images/fbsignup.png" OnClick="fblogin_click" />
                            <br />
                            <br />
                            <br />
                            <asp:Label ID="debug" runat="server" Text="Debugging: Referring Username / Referring Aid" Visible="False"></asp:Label>
                            <br />
                            </span>
                        </td>
                    </tr>
